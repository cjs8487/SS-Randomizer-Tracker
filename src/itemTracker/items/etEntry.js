        ...
        switch(current) {
            case 0:
                return <div id={"ET-entry-key"}>
                    <img src={noEntry} onClick={this.handleClick} alt={"No ET entry key pieces"}/>
                </div>
            case 1:
                return <div id={"ET-entry-key"}>
                    <img src={Entry_1} onClick={this.handleClick} alt={"1 ET entry key piece"}/>
                </div>
            case 2:
                return <div id={"ET-entry-key"}>
                    <img src={Entry_2} onClick={this.handleClick} alt={"2 ET entry key pieces"}/>
                </div>
            case 3:
                return <div id={"ET-entry-key"}>
                    <img src={Entry_3} onClick={this.handleClick} alt={"3 ET entry key pieces"}/>
                </div>
            case 4:
                return <div id={"ET-entry-key"}>
                    <img src={Entry_4} onClick={this.handleClick} alt={"4 ET entry key pieces"}/>
                </div>
            case 5:
                return <div id={"ET-entry-key"}>
                    <img src={Entry_5} onClick={this.handleClick} alt={"5 ET entry key pieces"}/>
                </div>
            default:
                return null
        }
