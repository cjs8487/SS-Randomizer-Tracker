                    ...
                    <ul style={{ padding: '2%' }}>
                        {
                            this.props.logic.areas().filter((area) => !areaBlacklist.includes(area)).map((value) => (
                                <LocationGroupHeader title={value} logic={this.props.logic} colorScheme={this.props.colorScheme} onClick={this[_.camelCase(`open${value}`)]} onHintClick={this.props.handleHintClick} />
                            ))
                        }
                    </ul>
                </Row>
